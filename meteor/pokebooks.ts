...
module Dictionary {
    ...
    export var pokemons = [
        ...
        {pokemon_name: 'ロトム(ヒートフォルム)', pokemon_id: '479'},
        {pokemon_name: 'ロトム(ウォッシュフォルム)', pokemon_id: '479'},
        {pokemon_name: 'ロトム(フロストフォルム)', pokemon_id: '479'},
        {pokemon_name: 'ロトム(スピンフォルム)', pokemon_id: '479'},
        {pokemon_name: 'ロトム(カットフォルム)', pokemon_id: '479'},
